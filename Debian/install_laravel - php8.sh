...
bash -c 'echo "extension=swoole.so" >> /etc/php/8.0/cli/php.ini'
# Instala Redis
...
chown -R :www-data /var/www/SIGA/storage/
chown -R :www-data /var/www/SIGA/bootstrap/cache/
chmod -R 0777 /var/www/SIGA/storage/
chmod -R 0777 /var/www/SIGA/bootstrap/cache/
chown -R www-data.www-data /var/www/SIGA/storage
chown -R www-data.www-data /var/www/SIGA/bootstrap/cache
mkdir -p /var/www/SIGA
